    ...
    define(['pageController'], function() {
        return [
            ...
            function($scope,$httpService,config,params,$routeParams,eventBusService,controllerName,loggingService) {	
            	...
            	$scope.titles={};
            	$scope.options={};
            	$scope.options.FK_TEACHER = params.teacherPk;
            	$scope.options.SURVEY_QUEST_ID = params.pk;
            	...
            	$scope.find = function() { 
            		...
            		//选项查询 
            		$scope.options.SURVEY_CONTENT_ID = params.optionId; 
            		$scope.options.page = JSON.stringify($scope.page);
                	$httpService.post(config.findSynthByUserPkURL,$scope.options).success(function(data) {
