                	...
                	$httpService.post(config.findScCourseNoticeURL,$scope.form).success(function(data) {
                    	if(data.code != '0000'){
                    		loggingService.info(data.msg);
                    		 ...
                    		 $scope.noticeList[0].NOTICECONTENT = $scope.noticeList[0].NOTICECONTENT.replace('松江','浦东').replace("tetraining.sjedu","hygl.pdedu").replace("tetraining.sjedu","hygl.pdedu").replace("TeacherEDU","api").replace("TeacherEDU","api");
